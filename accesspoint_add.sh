...
if [ "$3" = "True" ]; then
    nmcli con modify Helperbox ipv4.method manual && nmcli con modify Helperbox ipv4.addresses "192.168.1.100/24" && nmcli con modify Helperbox ipv4.gateway "192.168.1.1"
else
