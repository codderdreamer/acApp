    ...
    def deviceState(self, value):
        ...
        if self.__deviceState != value:
            ...
            if self.__deviceState == DeviceState.CONNECTED:
                ...
                asyncio.run_coroutine_threadsafe(self.ensureFutures.on_status_notification(connector_id=1,error_code=ChargePointErrorCode.noError,status=ChargePointStatus.available),self.loop)
