...
class BluetoothServer:
    ...
    def bluetooth_config(self):
        subprocess.Popen(["rfkill", "unblock", "all"]).wait()
        time.sleep(2)
        ...
        time.sleep(2)
        subprocess.Popen(["bluetoothctl", "power", "on"]).wait()
        time.sleep(2)
        subprocess.Popen(["bluetoothctl", "discoverable", "on"]).wait()
        time.sleep(2)
        subprocess.Popen(["bluetoothctl", "pairable", "on"]).wait()
        time.sleep(2)
        subprocess.Popen(["bluetoothctl", "agent", "on"]).wait()
        time.sleep(2)
        subprocess.Popen(["bluetoothctl", "agent", "KeyboardDisplay"]).wait()
        time.sleep(2)
        subprocess.Popen(["bluetoothctl", "default-agent"]).wait()
        time.sleep(2)
        subprocess.Popen(["hciconfig", "hci","piscan"]).wait()
        time.sleep(2)
        print("*************************")
