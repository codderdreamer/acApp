...
class ApplicationBluetooth(dbus.service.Object):
    ...
    def __init__(self,bus,application):
        ...
        self.add_service(NetworkPriorityService(bus, 1, self.application))
        self.add_service(SettingsFourGService(bus, 1, self.application))
        self.add_service(EthernetSettingsService(bus, 1, self.application))
        self.add_service(DNSSettingsService(bus, 1, self.application))
