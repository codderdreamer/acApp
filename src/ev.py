...
class EV():
    ...
    def control_error_list(self):
        ...
        while True:
            ...
            rcd_init_error = False
            locker_init_error = False
            print("self.charge",self.charge,"self.application.chargingStatus",self.application.chargingStatus,"self.application.serialPort.error_list",self.application.serialPort.error_list)
            if self.charge:
